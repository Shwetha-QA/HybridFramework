...
public class Utility 
{
	...
	public static WebElement getElement(WebDriver driver, By locator) {
		...
		{
			waitForSecond(Integer.parseInt(ConfigReader.getProperty("speed")));
		}
	...
	public static void clickElement(WebDriver driver, WebElement ele) {
		...
		try 
		{
			...
			try 
			{
				System.out.println("Actions Click Failed :Trying Click Using Actions Class Click ");
				...
				System.out.println("Actions Click Failed :Trying Click Using JavaScriptExecutor");
	...
	public static void waitForSecond(int scriptSpeed) {
		try 
		{
			Thread.sleep(scriptSpeed * 1000);
